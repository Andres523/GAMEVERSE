...
@keyframes yippee {
  ...
  60% {
    ...
    fill: var(--fill);
                                    ...
                                    <textarea name="comentario" id="comentario" rows="4" cols="50" maxlength="150" style="background-color: #333; color: white; border: 1px solid #ccc; border-radius: 5px; padding: 5px; resize: none;"></textarea>
                                    <br>
                                    <br>
                                    <br>
                                    <style>
                                    ...
                                    <center><button type="submit" class="button1">Enviar</button></center>
                                    <br>
                                    <style>
.button1 {
  position: relative;
