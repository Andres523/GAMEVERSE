...
<br>
                                    ...
                                    <label class="pass">
                                        <input type="checkbox" checked="checked" onclick="toggleMostrarContrasena()">
                                    ...
                                    <div class="tab2">          
                                        ...
                                        if (mysqli_num_rows($resultado) > 0) {
                                            ...
                                            while ($fila = mysqli_fetch_assoc($resultado)) {
                                                ...
                                                echo '<td> 
                                                        <button class="edit-btn" onclick="editarProducto(' . $fila['id'] . ')">Editar</button>
                                                        <button class="delete-btn" onclick="eliminarProducto(' . $fila['id'] . ')">Eliminar</button>
                                                      </td>';
